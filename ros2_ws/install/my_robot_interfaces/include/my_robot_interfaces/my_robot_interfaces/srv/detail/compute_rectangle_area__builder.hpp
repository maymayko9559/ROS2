...
class Init_ComputeRectangleArea_Request_witdth
{
public:
  explicit Init_ComputeRectangleArea_Request_witdth(::my_robot_interfaces::srv::ComputeRectangleArea_Request & msg)
  : msg_(msg)
  {}
  ::my_robot_interfaces::srv::ComputeRectangleArea_Request witdth(::my_robot_interfaces::srv::ComputeRectangleArea_Request::_witdth_type arg)
  {
    msg_.witdth = std::move(arg);
...
public:
  ...
  {}
  Init_ComputeRectangleArea_Request_witdth length(::my_robot_interfaces::srv::ComputeRectangleArea_Request::_length_type arg)
  {
    msg_.length = std::move(arg);
    return Init_ComputeRectangleArea_Request_witdth(msg_);
  }
