...
bool my_robot_interfaces__msg__hardware_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // debug_messages
    PyObject * field = PyObject_GetAttrString(_pymsg, "debug_messages");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->debug_messages, PyBytes_AS_STRING(encoded_field));
...
PyObject * my_robot_interfaces__msg__hardware_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // debug_messages
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->debug_messages.data,
      strlen(ros_message->debug_messages.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "debug_messages", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
