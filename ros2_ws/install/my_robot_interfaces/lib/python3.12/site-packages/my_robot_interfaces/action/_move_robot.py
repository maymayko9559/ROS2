    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'my_robot_interfaces.action.MoveRobot_Goal')
            logger.debug(
...
class Metaclass_MoveRobot_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.action.MoveRobot_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveRobot_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.action.MoveRobot_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveRobot_SendGoal_Request(metaclass=Metaclass_MoveRobot_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'my_robot_interfaces/MoveRobot_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'action'], 'MoveRobot_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from my_robot_interfaces.action._move_robot import MoveRobot_Goal
...
class MoveRobot_SendGoal_Event(metaclass=Metaclass_MoveRobot_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<my_robot_interfaces/MoveRobot_SendGoal_Request, 1>',
        'response': 'sequence<my_robot_interfaces/MoveRobot_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'action'], 'MoveRobot_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'action'], 'MoveRobot_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from my_robot_interfaces.action import MoveRobot_SendGoal_Request
    ...
    def response(self, value):
        if self._check_fields:
            from my_robot_interfaces.action import MoveRobot_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_MoveRobot_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.action.MoveRobot_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_robot_interfaces.action import _move_robot
...
class MoveRobot_SendGoal(metaclass=Metaclass_MoveRobot_SendGoal):
    from my_robot_interfaces.action._move_robot import MoveRobot_SendGoal_Request as Request
    from my_robot_interfaces.action._move_robot import MoveRobot_SendGoal_Response as Response
    from my_robot_interfaces.action._move_robot import MoveRobot_SendGoal_Event as Event
...
class MoveRobot_GetResult_Response(metaclass=Metaclass_MoveRobot_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'my_robot_interfaces/MoveRobot_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'action'], 'MoveRobot_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from my_robot_interfaces.action._move_robot import MoveRobot_Result
...
class MoveRobot_GetResult_Event(metaclass=Metaclass_MoveRobot_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<my_robot_interfaces/MoveRobot_GetResult_Request, 1>',
        'response': 'sequence<my_robot_interfaces/MoveRobot_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'action'], 'MoveRobot_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'action'], 'MoveRobot_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from my_robot_interfaces.action import MoveRobot_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from my_robot_interfaces.action import MoveRobot_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_MoveRobot_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.action.MoveRobot_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveRobot_GetResult(metaclass=Metaclass_MoveRobot_GetResult):
    from my_robot_interfaces.action._move_robot import MoveRobot_GetResult_Request as Request
    from my_robot_interfaces.action._move_robot import MoveRobot_GetResult_Response as Response
    from my_robot_interfaces.action._move_robot import MoveRobot_GetResult_Event as Event
...
class Metaclass_MoveRobot_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.action.MoveRobot_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveRobot_FeedbackMessage(metaclass=Metaclass_MoveRobot_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'my_robot_interfaces/MoveRobot_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'action'], 'MoveRobot_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from my_robot_interfaces.action._move_robot import MoveRobot_Feedback
...
class Metaclass_MoveRobot(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.action.MoveRobot')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveRobot(metaclass=Metaclass_MoveRobot):
    ...
    from my_robot_interfaces.action._move_robot import MoveRobot_Goal as Goal
    # The result message defined in the action definition.
    from my_robot_interfaces.action._move_robot import MoveRobot_Result as Result
    # The feedback message defined in the action definition.
    from my_robot_interfaces.action._move_robot import MoveRobot_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from my_robot_interfaces.action._move_robot import MoveRobot_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from my_robot_interfaces.action._move_robot import MoveRobot_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from my_robot_interfaces.action._move_robot import MoveRobot_FeedbackMessage as FeedbackMessage
