...
class CountUntil_SendGoal_Event(metaclass=Metaclass_CountUntil_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<my_robot_interfaces/CountUntil_SendGoal_Request, 1>',
        'response': 'sequence<my_robot_interfaces/CountUntil_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'action'], 'CountUntil_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'action'], 'CountUntil_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from my_robot_interfaces.action import CountUntil_SendGoal_Request
    ...
    def response(self, value):
        if self._check_fields:
            from my_robot_interfaces.action import CountUntil_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class CountUntil_SendGoal(metaclass=Metaclass_CountUntil_SendGoal):
    ...
    from my_robot_interfaces.action._count_until import CountUntil_SendGoal_Event as Event
...
class CountUntil_GetResult_Event(metaclass=Metaclass_CountUntil_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<my_robot_interfaces/CountUntil_GetResult_Request, 1>',
        'response': 'sequence<my_robot_interfaces/CountUntil_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'action'], 'CountUntil_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'action'], 'CountUntil_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from my_robot_interfaces.action import CountUntil_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from my_robot_interfaces.action import CountUntil_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class CountUntil_GetResult(metaclass=Metaclass_CountUntil_GetResult):
    ...
    from my_robot_interfaces.action._count_until import CountUntil_GetResult_Event as Event
