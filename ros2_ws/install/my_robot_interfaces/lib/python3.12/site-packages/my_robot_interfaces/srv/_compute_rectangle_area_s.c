...
bool my_robot_interfaces__srv__compute_rectangle_area__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // witdth
    PyObject * field = PyObject_GetAttrString(_pymsg, "witdth");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->witdth = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * my_robot_interfaces__srv__compute_rectangle_area__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // witdth
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->witdth);
    {
      int rc = PyObject_SetAttrString(_pymessage, "witdth", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
