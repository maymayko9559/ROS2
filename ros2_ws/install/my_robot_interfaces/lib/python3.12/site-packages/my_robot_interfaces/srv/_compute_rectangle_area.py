...
class ComputeRectangleArea_Request(metaclass=Metaclass_ComputeRectangleArea_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.witdth = kwargs.get('witdth', float())
    ...
    @builtins.property
    def witdth(self):
        """Message field 'witdth'."""
        return self._witdth

    @witdth.setter
    def witdth(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'witdth' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'witdth' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._witdth = value
...
class Metaclass_ComputeRectangleArea_Event(type):
    """Metaclass of message 'ComputeRectangleArea_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__compute_rectangle_area__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__compute_rectangle_area__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__compute_rectangle_area__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__compute_rectangle_area__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__compute_rectangle_area__event
...
class ComputeRectangleArea_Event(metaclass=Metaclass_ComputeRectangleArea_Event):
    """Message class 'ComputeRectangleArea_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<my_robot_interfaces/ComputeRectangleArea_Request, 1>',
        'response': 'sequence<my_robot_interfaces/ComputeRectangleArea_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'srv'], 'ComputeRectangleArea_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'srv'], 'ComputeRectangleArea_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from my_robot_interfaces.srv import ComputeRectangleArea_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ComputeRectangleArea_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ComputeRectangleArea_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from my_robot_interfaces.srv import ComputeRectangleArea_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ComputeRectangleArea_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ComputeRectangleArea_Response'"
...
class Metaclass_ComputeRectangleArea(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _compute_rectangle_area.Metaclass_ComputeRectangleArea_Event._TYPE_SUPPORT is None:
                _compute_rectangle_area.Metaclass_ComputeRectangleArea_Event.__import_type_support__()
...
class ComputeRectangleArea(metaclass=Metaclass_ComputeRectangleArea):
    ...
    from my_robot_interfaces.srv._compute_rectangle_area import ComputeRectangleArea_Event as Event
